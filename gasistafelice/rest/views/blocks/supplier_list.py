...
#TODO placeholder domthu: clean block which is copied from blocks/details.py
#TODO and implement supplier_list


#TODO BOTH THIS AND OTHER _list BLOCK CAN INHERIT FROM BlockWithList
#TODO START FROM  render_details_block and the get_response
