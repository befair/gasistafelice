...
class WorkflowBase(object):
    ...
    def get_workflow(self):
        ...
        """
        return gasistafelice.workflows.utils.get_workflow(self)
    ...
    def remove_workflow(self):
        ...
        """
        return gasistafelice.workflows.utils.remove_workflow_from_object(self)
    ...
    def set_workflow(self, workflow):
        ...
        **Parameters:**
        ...
        """
        return gasistafelice.workflows.utils.set_workflow_for_object(workflow)

    def get_state(self):
        """Returns the current workflow state of the object.
        """
        return gasistafelice.workflows.utils.get_state(self)

    def set_state(self, state):
        """Sets the workflow state of the object.
        """
        return gasistafelice.workflows.utils.set_state(self, state)
    ...
    def get_allowed_transitions(self, user):
        ...
        """
        return gasistafelice.workflows.utils.get_allowed_transitions(self, user)

    def do_transition(self, transition, user):
        """Processes the passed transition (if allowed).
        """
        return gasistafelice.workflows.utils.do_transition(self, transition, user)