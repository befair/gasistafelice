...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DBNAME', 'gf_dev'),
        'USER': os.getenv('POSTGRES_USERNAME', 'gf_dev'),
...
LOG_FILE = os.getenv('APP_LOG_FILE', os.path.join(PROJECT_ROOT, 'gf.log'))
LOG_FILE_DEBUG = os.getenv('APP_LOG_FILE_DEBUG', os.path.join(PROJECT_ROOT, 'gf_debug.log'))
...
locale.setlocale(locale.LC_ALL, os.getenv('APP_LC_ALL', 'it_IT.UTF-8'))
#DOMTHU:
...
PROFILE_LOG_BASE = os.getenv('APP_PROFILE_LOG_BASE', PROJECT_ROOT + '/profiling_logs')
