...
from gf.base.workflows_utils import get_workflow, set_workflow, get_state, do_transition, get_allowed_transitions
#from history.models import HistoricalRecords

from gf.base.models import PermissionResource, Place, DefaultTransition

from gf.base import validators

from lib.fields.models import CurrencyField, PrettyDecimalField
from lib.fields import display
from lib import ClassProperty, unordered_uniq
from lib.djangolib import queryset_from_iterable
from gf.supplier.models import Supplier
from gf.gas.models.base import GASMember, GASSupplierSolidalPact, GASSupplierStock
from gf.gas.managers import AppointmentManager, OrderManager
from gf.gas.query import AppointmentQuerySet, OrderQuerySet
from gf.gas import signals
from gf.base.models import Person
from consts import *
from consts import FAKE_WITHDRAWN_AMOUNT
from gf.gas.workflow_data import STATUS_PREPARED, STATUS_OPEN
from gf.gas.workflow_data import STATUS_CLOSED, STATUS_UNPAID
from gf.gas.workflow_data import STATUS_ARCHIVED, STATUS_CANCELED

from gf.gas.workflow_data import TRANSITION_OPEN, TRANSITION_CLOSE, TRANSITION_CLOSE_EMAIL
from gf.gas.workflow_data import TRANSITION_ARCHIVE, TRANSITION_UNPAID, TRANSITION_CANCEL


from utils import long_date, medium_date
...
WHERE order_id = %s \
    ...
    @property
    def stocks(self):
        from gf.supplier.models import SupplierStock
