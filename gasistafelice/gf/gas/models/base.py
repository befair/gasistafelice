...
from gf.base.models import PermissionResource, Person, Place, Contact
from gf.base import const
from gf.base import utils as base_utils

from gf.gas.accounting import GasAccountingProxy
...
class GAS(models.Model, PermissionResource):
    ...
    @property
    def deliveries(self):
        from gf.gas.models.order import Delivery
    ...
    def withdrawals(self):
        from gf.gas.models.order import Withdrawal
    ...
    def orderable_products(self):
        from gf.gas.models import GASSupplierOrderProduct
...
#        models.CharField(max_length=100, name="fax", verbose_name=_("Fax")),
    ...
    def basket_to_be_delivered(self):
        ...
        #WAS: from gf.gas.models import GASMemberOrder
...
class GASSupplierSolidalPact(models.Model, PermissionResource):
    ...
    >>> from gf.gas.models.base import GAS, GASSupplierSolidalPact
    ...
    >>> from gf.gas.models.order import *
