...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        ## Deleting field 'HistoricalGASConfig.is_active'
        #db.delete_column('gas_historicalgasconfig', 'is_active')

        # Deleting field 'GASConfig.is_active'
        db.delete_column('gas_gasconfig', 'is_active')


    def backwards(self, orm):
        
        ## Adding field 'HistoricalGASConfig.is_active'
        #db.add_column('gas_historicalgasconfig', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'GASConfig.is_active'
        db.add_column('gas_gasconfig', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
