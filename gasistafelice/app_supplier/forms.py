...
from lib.fields.forms import CurrencyField, TolerantDecimalField
from lib.formsets import BaseFormSetWithRequest

from app_base.const import ALWAYS_AVAILABLE
from app_base.forms import BaseRoleForm
from consts import SUPPLIER_REFERRER
from app_base.models import Person
from app_supplier.models import SupplierStock, Product, \
