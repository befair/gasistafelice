...
from app_gas.models import GAS, GASMember, GASSupplierStock, GASSupplierSolidalPact,\
GASMemberOrder, GASSupplierOrder, GASSupplierOrderProduct, Delivery, Withdrawal
from app_gas.managers import GASMemberManager

from app_supplier.models import Supplier, SupplierStock, Product, ProductCategory, ProductPU
...
class GASSupplierOrderProductTest(TestCase):
    ...
    def setUp(self):
        ...
        from app_gas.workflow_data import workflow_dict
        import workflows
