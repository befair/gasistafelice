...
from utils import long_date

from app_base.models import PermissionResource, Person, Place, Contact
from app_base import const
from app_base import utils as base_utils

from app_gas.accounting import GasAccountingProxy

from consts import GAS_REFERRER_SUPPLIER, GAS_REFERRER_TECH, GAS_REFERRER_CASH, GAS_MEMBER, GAS_REFERRER

from app_supplier.models import Supplier, SupplierStock, Product, ProductCategory
from app_gas.managers import GASMemberManager, IncludeSuspendedGASMemberManager
...
class GAS(models.Model, PermissionResource):
    ...
    @property
    def deliveries(self):
        from app_gas.models.order import Delivery
    ...
    def withdrawals(self):
        from app_gas.models.order import Withdrawal
    ...
    def orderable_products(self):
        from app_gas.models import GASSupplierOrderProduct
...
#        models.CharField(max_length=100, name="fax", verbose_name=_("Fax")),
    ...
    def basket_to_be_delivered(self):
        ...
        #WAS: from app_gas.models import GASMemberOrder
...
class GASSupplierSolidalPact(models.Model, PermissionResource):
    ...
    >>> from app_gas.models.base import GAS, GASSupplierSolidalPact
    ...
    >>> from app_gas.models.order import *
