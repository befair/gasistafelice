# -*- coding: utf-8 -*-
#
# DES User Manual documentation build configuration file, created by
...
project = u'Manuale utente di Gasista Felice'
copyright = u'2011, Rete di Economia Etica e Solidale delle Marche'
...
htmlhelp_basename = 'GFUserManualdoc'
...
latex_documents = [
  ('index', 'GFUserManual.tex', u'Manuale utente Gasista Felice',
   u'Rete di Economia Etica e Solidale delle Marche', 'manual'),
]
...
.. |sym_pact| replace:: **TODO** icona patto di solidarietà
...
.. |head2_homepage| replace:: Pagina iniziale
.. |head2_actions| replace:: Azioni
